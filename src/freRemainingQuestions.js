  ...
  [
    {
      ...
      answers: [
        ...
        entry("rule-702-education", "education", [], "4"),
        entry("rule-702-training", "training", [], "5"),
...
const rule901Examples = [
  // CONT'D: Comparison, Opinion, Nonexpert, Testimony, Distinctive.
  ...
  // PASTS: Public, Ancient, System, Telephone, Statute.
...
const rule902Items = [
  // FOCUS: Foreign, Official, Certified copies, Unsealed, Sealed.
  ...
  // PANTS: Paper, Acknowledged, Newspapers, Trade, Statutory presumptions.
  ...
  // FEED: Foreign, Electronic process, Electronic copies, Domestic.
